...
const seed = async () => {
  try {
    ...
    const lessonsData = [
      ...
      { moduleSlug: 'horse', title: 'Морины уралдааны соёл', description: 'Наадам, хурдан морины бэлтгэл, уяа сойлго', content: 'Хурдан морийг хүүхэд унуулна, 35 км зайд давхилна...', durationMin: 10, level: 'Ахисан', xpReward: 100, order: 3 },
      ...
      { moduleSlug: 'livestock', title: 'Нүүдлийн соёл ба бэлчээр', description: 'Босоо, хэвтээ нүүдэл, зуслан, өвөлжөө', content: 'Говь, тал, хээр, уул, ойн бүсэд мал сүргийг бэлчээрлүүлэх...', durationMin: 14, level: 'Ахисан', xpReward: 90, order: 4 },
      // --- Цагаан идээ ---
      ...
      { moduleSlug: 'dairy', title: 'Өрөм, ааруул, ээзгий хийх урлал', description: 'Сүү хөөрүүлж өрөм авах, аарц буцалгаж ааруул тавих, ээдмийг хатаах', content: 'Аарцыг уутанд хийж шүүх, хэвэнд оруулах, хатаах...', durationMin: 15, level: 'Ахисан', xpReward: 100, order: 3 },
      ...
      { moduleSlug: 'ger', title: 'Гэр цагийн үүрэг гүйцэтгэх нь', description: 'Тооноор нарны туяа, 12 жилийн хуваарь, 12 цаг', content: 'Хулгана, үхэр, бар, туулай... гэсэн 12 амьтны нэрээр цагийг тэмдэглэх...', durationMin: 10, level: 'Ахисан', xpReward: 90, order: 3 },
    ...
    // Морь
    const horseQuiz = await Quiz.create({ moduleSlug: 'horse', title: 'Морь, айрагны соёл', passingScore: 70 });
    await Question.insertMany([
    ...
    // Гэр
    const gerQuiz = await Quiz.create({ moduleSlug: 'ger', title: 'Монгол гэр', passingScore: 70 });
    await Question.insertMany([
